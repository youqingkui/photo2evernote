...
ENEM_HEAD = '<?xml version="1.0" encoding="UTF-8"?>
<!DOCTYPE en-export SYSTEM "http://xml.evernote.com/pub/evernote-export3.dtd">
<en-export export-date="20150420T023922Z" application="Evernote" version="Evernote Mac 6.0.8 (451398)">
<note><title>无标题</title><content><![CDATA[<?xml version="1.0" encoding="UTF-8" standalone="no"?>
...
createENEM_RES_END = (res) ->
  return "</data><mime>#{res.mime}</mime><width></width><height></height><duration>0</duration><resource-attributes>
          <file-name>#{res.img}</file-name>
          </resource-attributes>"
