...
(function() {
  var ENEM_END, ENEM_RES_HEAD, Evernote, MIME_TO_EXTESION_MAPPING, argv, async, creatImportNote, createENEM_HEAD, createENEM_RES_END, createEmailNote, createHashHex, crypto, email, exec, f, filterImg, fs, fse, gimgFiles, isNumber, l, mime, noteStore, pwd, readImg, shell, sliceImg, t, _ref;
  ...
  creatImportNote = function(filter, noteTitle, cb) {
    ...
    return async.auto({
      ...
      cImportNote: [
        'filter', function(cb, result) {
          ...
          return creatImportNote(filter, noteTitle, cb);
        }
      ]
    });
  };
